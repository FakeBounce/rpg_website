    ...
    render() {
        ...
        return (
            <div style={{height: "100%"}}>
                ...
                <div style={{overflowY:'auto', height: '90%'}}><div className="commit"> fakebounce, le 2018-10-03 : Game master is now Up ! He can modify a character directly by clicking on a team portrait. Can also add gold. Fixed some number inputs which sends strings and character Tabs if array was empty </div>
